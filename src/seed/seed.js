...
function seedDefaultProjects() {
    ...
    //Cleaning Project
    const vaccumItem = TodoItem("Vaccum Living Room", "Magna eu exercitation fugiat qui. Magna mollit sint duis eu ea adipisicing aliqua irure.", formatDate(year, month, day), lowPriority());
